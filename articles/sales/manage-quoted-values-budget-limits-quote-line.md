...
description: يوفر هذا المقال معلومات حول استخدام بنود عرض أسعار المشروع لعمل المشروع.
author: rumant
ms.date: 10/01/2020
ms.topic: overview
...
| تضمين الرسوم | تشير علامة **نعم**/**لا** إلى ما إذا كانت الرسوم في المشروع المحدد سيتم تضمينها في التقدير لبند عرض الأسعار هذا أم لا. تشير علامة **لا** إلى أنه لن يتم تضمين الرسوم في التقدير لبند عرض الأسعار هذا. تشير علامة **نعم** إلى أن الرسوم سيتم تضمينها في التقدير لبند عرض الأسعار هذا. | يتم نسخ قيمة الحقل هذه إلى بند عقد المشروع الذي تم إنشاؤه من بند عرض الأسعار هذا عندما يتم ربح عرض الأسعار. |

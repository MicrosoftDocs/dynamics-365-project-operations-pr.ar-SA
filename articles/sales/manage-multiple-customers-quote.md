---
title: إدارة عدة عملاء على عرض أسعار قائم على المنتج
...
ms.locfileid: "9825132"
---
# <a name="manage-multiple-customers-on-a-project-based-quote"></a>إدارة عدة عملاء على عرض أسعار قائم على المنتج

_**ينطبق على:** Project Operations للسيناريوهات المستندة إلى موارد/منتجات غير مخزنة‬_

تدعم عروض الأسعار القائمة على المنتج السيناريو حيث يتضمن المقترح العديد من العملاء الذين سيمولون الصفقة. تتضمن علامة تبويب **الملخص** لعرض الأسعار حقل **العميل المحتمل** الذي يحدد العميل الأساسي للصفقة. يمكن إعداد العملاء الآخرين لهذه الصفقة على علامة تبويب **العملاء** لعرض أسعار المشروع.

...
ms.locfileid: "6992595"
---
# <a name="financial-estimates-for-materials-on-projects"></a>التقديرات المالية للمواد على المشروعات

_**ينطبق علي:** ‏‫Project Operations للسيناريوهات المستندة إلى مورد/غير مخزنة‬، ‏‫النشر الخفيف – التعامل مع الفواتير الأولية‬_

يسمح Dynamics 365 Project Operations لمدراء المشاريع بتحديد تكاليف المواد القائمة على المشروع لكل مشروع أو مهمة. يمكن أن يرتبط كل تقدير للمواد بمهمة مشروع محددة. يتم تصنيف المصروفات في فئات مصروفات مختلفة، والتي يتم تحديدها في المستوى التنظيمي. يتم تحديد التسعير والتكلفة لكل فئة مصروفات في قائمة الأسعار. 

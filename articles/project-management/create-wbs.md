...
description: يشرح هذا المقال كيفية إنشاء هيكل تنظيم العمل (WBS) مع عناصر التحكم الأساسية في واجهة الجدولة الجديدة.
author: ruhercul
ms.date: 12/16/2021
ms.topic: article
...
يتم الوصول إلى سمات التوظيف من خلال حقل **الموارد** في الجدول. يمكنك إما البحث عن مورد موجود، أو تحديد **إنشاء**، وفي جزء **الإنشاء السريع**، أضف عضو فريق مشروع كمورد جديد.  عند البحث عن مورد باستخدام منتقي الموارد في شبكة المهام أو طريقة عرض اللوحة أو غانت، يرجع البحث أعضاء فريق المشروع موجود أو موارد نشطة قابلة للحجز.
...
| الحد الأقصى لعدد عناصر قائمة اختيار لكل مهمة                   | 20                   |

...
> [!IMPORTANT]
> - لاستخدام ميزة إدارة المستندات في SharePoint لتخزين ملفات [!INCLUDE[pn_microsoft_project](../includes/pn-microsoft-project.md)] لمشاريع [!INCLUDE[pn_project_service_auto](../includes/pn-project-service-auto.md)]، سيحتاج مسؤول [!INCLUDE[pn_microsoft_project](../includes/pn-microsoft-project.md)] إلى تشغيل إدارة المستندات. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [تمكين إدارة مستندات SharePoint لكيانات محددة](../admin/enable-sharepoint-document-management-specific-entities.md)  
...
## <a name="upload-a-project-file-to-sharepoint-or-office-groups"></a>تحميل ملف مشروع إلى SharePoint أو مجموعات Office  
 يمكنك تحميل ملف مشروع إلى SharePoint والعثور عليه ضمن "المستندات المقترنة" لمشروع [!INCLUDE[pn_project_service_auto](../includes/pn-project-service-auto.md)] الخاص بك.  يجب أن تطلب من المسؤول تكوين إدارة مستندات في SharePoint وتشغيلها لكيان المشروع. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [إعداد تكامل SharePoint](../admin/set-up-sharepoint-integration.md)  

 يمكنك أيضًا تحميل ملف Project إلى [!INCLUDE[pn_onedrive_for_business](../includes/pn-onedrive-for-business.md)] إذا قمت بإعداد مجموعات Office. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [التعاون مع الزملاء باستخدام مجموعات Office 365](../basics/collaborate-with-colleagues-using-office-365-groups.md)  

...
## <a name="find-a-project"></a>البحث عن مشروع  
 ...
 ![قائمة بالمشاريع المطابقة للمهارات في تطبيق الأجهزة المحمولة "أداة البحث عن مشروعات"](../project-service/media/project-service-project-finder-list.png "قائمة بالمشاريع المطابقة للمهارات في تطبيق الأجهزة المحمولة "أداة البحث عن مشروعات"")  
...
## <a name="update-your-skills"></a>تحديث مهاراتك  
 ...
 ![زر "ملف التعريف" في تطبيق الأجهزة المحمولة "أداة البحث عن مشروعات"‬](../project-service/media/project-service-project-finder-profile.png "زر "ملف التعريف" في تطبيق الأجهزة المحمولة "أداة البحث عن مشروعات"‬")  

...
[!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [تثبيت Dynamics 365 للهواتف وأجهزة الكمبيوتر اللوحية](../mobile-app/install-dynamics-365-for-phones-and-tablets.md).
...
[!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [دليل أساسيات المحمول](../mobile-app/dynamics-365-phones-tablets-users-guide.md).

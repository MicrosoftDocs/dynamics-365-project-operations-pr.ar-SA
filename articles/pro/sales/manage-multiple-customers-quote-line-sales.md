---
title: إدارة عدة عملاء على بنود عرض أسعار المشروع
description: يصف هذا المقال كيفية إدارة عملاء متعددين على بنود عرض أسعار المشروع.
author: rumant
ms.date: 10/06/2020
ms.topic: article

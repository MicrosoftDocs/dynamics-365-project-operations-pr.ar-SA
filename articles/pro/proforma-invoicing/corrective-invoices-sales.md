...
description: يوفر هذا المقال معلومات حول كيفية إنشاء فواتير تصحيحية وتأكيدها في Project Operations.
author: rumant
ms.date: 04/05/2021
ms.topic: article
...
ms.locfileid: "9023643"
---
# <a name="corrective-project-invoices"></a>فواتير المشروع التصحيحية

...
description: يوفر هذا المقال أنماطًا شائعة لاستخدام الملحقات لتنفيذ الحقول المخصصة.
author: Yowelle
ms.date: 05/29/2019
ms.topic: article
ms.prod: ''
...
يوفر هذا المقال أنماطًا شائعة لاستخدام الملحقات لتنفيذ الحقول المخصصة. تم تناول المقالات التالية:
...
هذا المقال مخصص للمطورين الذين يقومون بدمج الحقول المخصصة في تطبيق Microsoft Dynamics 365 Project Timesheet للأجهزة المحمولة المتوفر لـ Apple iOS وGoogle Android. الافتراض هو أن القراء على دراية بتطوير X ++ ووظائف الجدول الزمني للمشروع.

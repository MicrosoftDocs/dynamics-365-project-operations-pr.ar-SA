---
title: مزامنة فئات مصروفات المشروع بين التمويل والعمليات و Project Service Automation
description: يصف هذا المقال القوالب والمهام الأساسية التي يتم استخدامها لمزامنة فئات مصروفات المشروع بين Microsoft Dynamics 365 Finance وDynamics 365 Project Service Automation.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9028916"
---
# <a name="synchronize-project-expense-categories-between-finance-and-operations-and-project-service-automation"></a>مزامنة فئات مصروفات المشروع بين التمويل والعمليات و Project Service Automation

[!include[banner](../includes/banner.md)]

يصف هذا المقال القوالب والمهام الأساسية التي يتم استخدامها لمزامنة فئات مصروفات المشروع بين Dynamics 365 Finance وDynamics 365 Project Service Automation.

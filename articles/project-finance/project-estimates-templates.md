...
- إذا كنت تقوم بإنشاء قالب جديد ، فيجب عليك أضافه هذا العمود. في Power Query، حدد **إضافه عمود شرطي**، وادخل اسما للعمود الجديد، مثل **معرف النموذج**. أدخل الشرط للعمود ، حيث ، إذا لم تكن مهمة المشروع فارغه، \<فأدخل معرف نموذج التنبؤ\>؛ قيمه فارغة أخرى.
...
- إذا كنت تقوم بإنشاء قالب جديد ، فيجب عليك أضافه هذا العمود. في Power Query، حدد **إضافه عمود شرطي**، وادخل اسما للعمود الجديد، مثل **معرف النموذج**. أدخل الشرط للعمود ، حيث ، إذا لم يكن معرف سطر التقدير فارغًا، \<فأدخل معرف نموذج التنبؤ\>؛ قيمه فارغة أخرى.

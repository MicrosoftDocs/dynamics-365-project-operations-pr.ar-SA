...
description: يوفر هذا المقال معلومات حول التحديثات الإصلاحية المتوفرة في إصدار ديسمبر 2020 من Project Operations للسيناريوهات المستندة إلى الموارد/غير المخزنة.
author: sigitac
ms.date: 12/04/2020
ms.topic: article
ms.prod: ''
...
| الوقت والمصروفات              | 2081793          | يجب القيام بتعيين **اسم فئة المصروفات** إلى حقل **وصف فئة المصروفات** في تطبيقات التمويل والعمليات                                                  |

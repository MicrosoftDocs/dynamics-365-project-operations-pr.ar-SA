...
description: يشرح هذا المقال كيفية قيام المسؤول بإجراء عمليات تصحيح فردية أو مجمعة على إدخالات الوقت أو المصروفات التي تمت الموافقة عليها في وقت سابق في حالة عدم اكتمال الفوترة.
author: rumant
ms.date: 04/02/2020
ms.topic: article
...
لإكمال الإجراءات في هذا المقال، ستحتاج إلى أذونات المسؤول.

...
على سبيل المثال، في المشروع Z، تكون وحدة مؤسسة التعاقد هي مؤسسة Contoso في الولايات المتحدة. في خطة المشروع، تم تعيين مهام الاختبار ضمن مرحلة التنفيذ إلى دور المستشار الفني ووحدة المؤسسة المعينة هي مؤسسة Contoso في الهند.

![تعيين مؤسسة مرحلة التنفيذ](media/org-unit-assignment-09.png)

بعد مرحلة التنفيذ، يتم تعيين مهمة اختبار التكامل لدور المستشار الفني، ولكن يتم تعيين المؤسسة إلى مؤسسة Contoso في الولايات المتحدة الأمريكية.  

![تعيين مؤسسة مهمة اختبار التكامل](media/org-unit-generate-team-10.png)

عندما تقوم بإنشاء فريق للمشروع، يتم إنشاء اثنين من أعضاء الفريق العامين بسبب وحدات المؤسسة المختلفة في المهام. سيتم تعيين مهام مؤسسة Contoso في الهند للمستشار الفني رقم 1 وسيتم تعيين مهام مؤسسة Contoso في الولايات المتحدة للمستشار الفني رقم 2.  
...
بالنسبة للمهام التي تم تعيينها إلى دور به وحدة مؤسسة تختلف عن وحدة المؤسسة الخاصة بمشروع التعاقد، ولم يتم إنشاء فريق لها، ستقوم الترقية بإنشاء عضو فريق عام للدور، ولكنها ستستخدم وحدة التعاقد في المشروع لوحدة مؤسسة عضو الفريق. بالرجوع إلى المثال مع المشروع Z، مما يعني أن وحدة مؤسسة التعاقد Contoso في الولايات المتحدة، وأن مهام اختبار خطة المشروع في مرحلة التنفيذ قد تم تعيينها لدور المستشار الفني مع وحدة المؤسسة المعينة لمؤسسة Contoso في الهند. تم تعيين مهمة اختبار التكامل التي اكتملت بعد مرحلة التنفيذ لدور المستشار الفني. وحدة المؤسسة هي مؤسسة Contoso في الولايات المتحدة ولم يتم إنشاء فريق. ستقوم عملية الترقية بإنشاء عضو واحد عام للفريق، وهو مستشار فني يتمتع بالساعات التي تم تعيينها لكافة المهام الثلاثة، ووحدة المؤسسة الخاصة بمؤسسة Contoso في الولايات المتحدة، وهي وحده مؤسسة التعاقد للمشروع.   

...
description: يقدم هذا المقال معلومات حول تعقب تقدم المشروع واستهلاك التكلفة.
author: ruhercul
ms.custom:
...
تختلف الحاجة إلى تعقب التقدم مقابل جدول حسب الصناعة. تتبع بعض الصناعات مستوى حبيبيًا ، بينما تتبع صناعات أخرى مستوى أعلى. يوضح هذا المقال كيفية الجدولة من أجل تلبية متطلبات مؤسستك.
